...
public class DirectorController {
    ...
    @FXML
    private TableColumn<DirectorVariables1, Integer> BonusColumn;
    ...
    @FXML
    private TableColumn<DirectorVariables1, Integer> IDColumn;
    ...
    @FXML
    private TableColumn<DirectorVariables1, String> NameColumn;

    @FXML
    private TableColumn<DirectorVariables1, String> PositionColumn;

    @FXML
    private TableColumn<DirectorVariables1, String> RoleColumn;

    @FXML
    private TableColumn<DirectorVariables1, Integer> SalaryColumn;
    ...
    public void setDirTable() throws SQLException {
        ...
        DirectorVariables1 director = new DirectorVariables1();
        ...
        while (true) {
            try {
                ...
                usersList.add(new DirectorVariables1(result.getInt("id"),
